...
/**
 * Classe responsável pelo controle dos elementos do jogo Paciência,
 * instanciando fundacoes, fileiras e estoque.
 * @author matee
 */
public class PacienciaController {
  public Fundacao fundacoes[] = new Fundacao[9];
  public Fileira fileiras[] = new Fileira[15];
